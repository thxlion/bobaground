...
const imgFrame3148 = "http://localhost:3845/assets/25b8bb39142b000c90f272d4c61fd536b62ad319.svg";
const imgGroup2398 = "http://localhost:3845/assets/e691ebffb0ee71221925fc2bcf63f0408ab79cc3.svg";
...
export const TopNav: React.FC = () => {
  ...
  return (
    <div className="bg-zinc-950 flex items-center justify-between px-[10px] py-[12px] h-16" role="navigation" aria-label="Primary">
      <div className="bg-black flex items-center gap-1 p-1 rounded-md" role="tablist" aria-label="Modes">
        <button role="tab" aria-selected={active==='explore'} onClick={() => setActive('explore')} className="flex items-center gap-2 px-[10px] py-2 rounded-md text-[#787879]">
          <img alt="Explore" src={imgFrame3148} className="size-[18px]" />
          <span className="text-sm leading-5">Explore</span>
        </button>
        <button role="tab" aria-selected={active==='image'} onClick={() => setActive('image')} className="flex items-center gap-2 px-[10px] py-2 rounded-[3px] bg-[#18181a] text-white">
        ...
        <button role="tab" aria-selected={active==='video'} onClick={() => setActive('video')} className="flex items-center gap-2 px-[10px] py-2 rounded-md text-[#787879]">
      ...
      <div className="flex items-center gap-2">
        <div className="bg-[#18181a] p-1 rounded-md">
          <div className="flex items-center gap-2 px-[10px] py-2 rounded-md">
            <span className="relative size-[18px]">
        ...
        <div className="bg-[#18181a] p-1 rounded-md size-[44px] flex items-center justify-center">
